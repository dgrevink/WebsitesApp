<?php 
 ...
 class testimonies extends MyActiveRecord {
	 ...
	 * eg: 
	 * <code>
	 * $testimonies = MyActiveRecord::Create('Testimonies');
	 * print $testimonies->id;	// NULL
	 * $testimonies->save();
	 * print $testimonies->id; // 1
	 * </code>
	 *
	 ...
	 * eg:
	 * <code>
	 * $testimonies = MyActiveRecord::FindById('Testimonies', 1);
	 * $testimonies->destroy();
	 * </code>
	 *
