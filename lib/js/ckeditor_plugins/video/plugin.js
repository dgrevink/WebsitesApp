...
CKEDITOR.plugins.setLang( 'video', 'fr', { video : {
		...
		fakeObject : 'Video',
		properties : 'Modifier de la video',
		widthRequired : 'La largeur ne peut pas être vide',
		heightRequired : 'La hauteur ne peut pas être vide',
		poster: 'Image poster',
		sourceVideo: 'Video source',
		sourceType : 'Type de video',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Votre navigateur ne supporte pas les videos.<br>Veuillez télécharger le fichier ici: %links%'
	}
} );
