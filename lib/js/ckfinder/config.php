...
require( dirname(__FILE__) . '/../../../application/config/config.php');

$starplace_config = $config;

unset($config);

define( "DEPLOYMENT",       $starplace_config['deployment']);
...
*/
$baseUrl = $starplace_config[DEPLOYMENT]['html_root'] . '/public/';
