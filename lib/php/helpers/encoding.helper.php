...
/**
	...
	$str = makeSafeEntities($str, $convertTags = 0, $encoding = "")
	$str = makeAllEntities($str, $useNamedEntities = 0, $encoding = "")
	$str = makeTagEntities($str, $useNamedEntities = 1)
	$str = makeAmpersandEntities($str, $useNamedEntities = 1)
