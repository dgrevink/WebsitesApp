...
*/
 ...
 $ACCESS_PWD=''; #md5 of script access password, SET IT if you want to protect script from public access
 
 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - always recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
	'user'=> $config[$config['deployment']]['db_user'],#required
	'pwd'=>$config[$config['deployment']]['db_password'], #required
	'db'=>$config[$config['deployment']]['db_name'],  #default DB, optional
	'host'=>$config[$config['deployment']]['db_server'],#optional
	'port'=>"",#optional
